                        ...
                        switch(d.f){
                            ...
                            case'created_timelapse_file_chunk':
                                if(!s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename]){
                                    ...
                                    console.log("file write stream",dir+d.filename);
                                }
                            ...
                            case'created_file_chunk':
                                console.log("write stream", s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename]);
                                if(!s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename]){
                            ...
                            break;
                            case'created_file':
                                console.log("created_file",s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename]);
                                if(!s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename]){
                                    return console.log('FILE NOT EXIST')
                                }
                                s.group[d.ke].activeMonitors[d.mid].childNodeStreamWriters[d.filename].end();
        ...
        childIO.on('c', function (d) {
            switch(d.f){
                ...
                case'insertCompleted'://close video
                    console.log("ChildIO insert Data");
